...
### 本项目新增/升级内容
- 更统一的高端极简 UI 设计与交互优化。
- OpenAI 兼容接口完善（DeepSeek / OpenAI / 第三方等），模型自动发现 + 手动输入。
...
### 实际效果
- 主界面：![image-20260213171804237](./assets/image-20260213171804237.png)
- 对话线程：![image-20260213171911255](./assets/image-20260213171911255.png)
- 渲染展示（表格/公式/图表）：
  - 图表：![image-20260213172127052](./assets/image-20260213172127052.png)
  - 表格：![image-20260213172047396](./assets/image-20260213172047396.png)
  - 公式：![image-20260213172147724](./assets/image-20260213172147724.png)

- 自定义提示词：![image-20260213172350714](./assets/image-20260213172350714.png)
